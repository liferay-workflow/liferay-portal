...
if (workflowEnabled) {
	workflowDefinitions = WorkflowDefinitionManagerSkipResourcePermission.getActiveWorkflowDefinitions(company.getCompanyId(), QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
}
