				...
				<aui:fieldset>
					...
					<c:if test="<%= (WorkflowHandlerRegistryUtil.getWorkflowHandler(DDLRecord.class.getName()) != null) && !scopeGroup.isLayoutSetPrototype() %>">
						<aui:select label="workflow" name="workflowDefinition">
							...
							<%
							List<WorkflowDefinition> workflowDefinitions = WorkflowDefinitionManagerSkipResourcePermission.getActiveWorkflowDefinitions(company.getCompanyId(), QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
