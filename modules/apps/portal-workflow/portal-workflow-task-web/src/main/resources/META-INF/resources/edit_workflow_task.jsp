...
Boolean hasPermission = WorkflowPermissionUtil.hasPermission(permissionChecker, themeDisplay.getScopeGroupId(), portletDisplay.getRootPortletId(), GetterUtil.getLong(primKey), ActionKeys.VIEW);
