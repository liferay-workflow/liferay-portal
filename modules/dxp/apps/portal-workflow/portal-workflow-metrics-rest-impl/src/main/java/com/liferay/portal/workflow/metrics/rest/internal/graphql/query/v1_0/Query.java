...
public class Query {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {processLastSLAResult(processId: ___){dateOverdue, id, lastCheckDate, name, onTime, remainingTime, status}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
