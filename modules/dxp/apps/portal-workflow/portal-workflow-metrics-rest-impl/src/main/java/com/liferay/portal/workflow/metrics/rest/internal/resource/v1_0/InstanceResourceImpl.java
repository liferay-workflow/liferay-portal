...
public class InstanceResourceImpl extends BaseInstanceResourceImpl {
	...
	private void _setSLAResults(
		...
		instanceIdtermsAggregation.addChildrenAggregations(
			slaDefinitionIdTermsAggregation);
		...
		Stream.of(
			...
			bucket -> _setSLAResults(
				bucket, instancesMap.get(GetterUtil.getLong(bucket.getKey())))
		);
	}
