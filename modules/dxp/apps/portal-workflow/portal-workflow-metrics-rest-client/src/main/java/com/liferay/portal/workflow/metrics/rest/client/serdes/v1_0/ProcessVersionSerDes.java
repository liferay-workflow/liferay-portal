...
public class ProcessVersionSerDes {
	...
	public static String toJSON(ProcessVersion processVersion) {
		...
		if (processVersion.getVersion() != null) {
			...
			sb.append(_escape(processVersion.getVersion()));
	...
	public static Map<String, String> toMap(ProcessVersion processVersion) {
		...
		if (processVersion.getVersion() == null) {
			...
			map.put("version", String.valueOf(processVersion.getVersion()));
		}
	...
	public static class ProcessVersionJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "version")) {
				if (jsonParserFieldValue != null) {
					processVersion.setVersion((String)jsonParserFieldValue);
				}
			}
		}
